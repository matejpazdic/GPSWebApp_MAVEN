...
<html>
    ...
    <body>
        <%
            ...
            boolean isGood = finder.isCorrectLogin(request.getParameter("Login"), request.getParameter("currPass"));
            ...
            if (isGood) {
                ...
                if(!pass.equals("")){
                    ...
                    if (pass.equals(reenteredPass)) {
                        ...
                        updater.updateUserData(email, email, firstName, lastName, activity, currpass, pass, age);
